...
| 8    | Runs **init.sql** on the new Postgres: checks out the **ey-ai-finance** repo and executes `db/<appChoice>/init.sql` (creates schema/tables).                                                                                                                                                                                 |
| 9    | Deploys **appservices-stack.bicep** into the resource group (frontend and backend App Services).                                                                                                                                                                                                                             |
